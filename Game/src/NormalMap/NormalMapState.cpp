...
namespace game
{
	BOOL NormalMapState::Init()
	{
		...
		lMaterial->SetDiffuseTextureId(graphics::RenderManager::Instance()->LoadTexture("brickwall.jpg"));
		...
		lMaterial->SetDiffuseTextureId(graphics::RenderManager::Instance()->LoadTexture("brickwall.jpg"));
		lMaterial->SetNormalTextureId(graphics::RenderManager::Instance()->LoadTexture("brickwall_normal.jpg"));
