...
namespace game
{
	...
	BOOL GameState::Init()
	{
		...
		const float32 lWallVertexData[] = {
			...
			-9.0f,  0.5f,  0.5f, -1.0f,  0.0f,  0.0f, 9.0f, 0.0f,
			-9.0f,  0.5f, -0.5f, -1.0f,  0.0f,  0.0f, 9.0f, 1.0f,
			...
			-9.0f, -0.5f, -0.5f, 0.0f, -1.0f,  0.0f, 0.0f, 1.0f,
			9.0f, -0.5f, -0.5f, 0.0f, -1.0f,  0.0f, 9.0f, 1.0f,
